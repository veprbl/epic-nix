{
  ...
  inputs.dd4hep-src = {
    url = "github:AIDASoft/DD4hep/v01-28";
    flake = false;
  };
  inputs.edm4eic-src = {
  ...
  inputs.epic-src = {
    url = "github:eic/epic/24.06.0";
    flake = false;
  };
  inputs.eicrecon-src = {
    url = "github:eic/EICrecon/v1.13.2";
    flake = false;
  };
  inputs.jana2-src = {
  ...
  inputs.juggler-src = {
    url = "gitlab:EIC/juggler/v14.0.3?host=eicweb.phy.anl.gov";
    flake = false;
  };
  inputs.podio-src = {
    url = "github:AIDASoft/podio/v00-99";
    flake = false;
  };

{
  ...
  inputs.dd4hep-src = {
    url = "github:AIDASoft/DD4hep/v01-36";
    flake = false;
  };
  inputs.edm4eic-src = {
    url = "github:eic/EDM4eic/v8.10.0";
    flake = false;
  };
  inputs.edm4hep-src = {
    url = "github:key4hep/EDM4hep/v01-01-01";
    flake = false;
  };
  ...
  inputs.jana2-src = {
    url = "github:JeffersonLab/JANA2/v2026.03.00";
    flake = false;
  };
  inputs.juggler-src = {
  ...
  inputs.osg-ca-certs-src = {
    url = "github:opensciencegrid/osg-certificates/v1.144.igtf.1.144";
    flake = false;
  };
  inputs.podio-src = {
    url = "github:AIDASoft/podio/v01-08";
    flake = false;
  };
  inputs.npsim-src = {
